...
export const projects: Project[] = [
  {
    ...
    description: [
      "Bread Loaf is one of those rare places where the most important things happening are invisible. The conversations between sessions. The moment a piece of writing finally clicks. The community that forms when people who have spent their lives alone with language suddenly find themselves surrounded by others who understand exactly what that means.",
      "Our job was to find a way to put that on screen.",
      "Writers are not natural film subjects. Many of them came to writing precisely because they prefer the page to the spotlight. Drawing out authentic, personal reflections from people who spend their professional lives choosing every word carefully requires patience, trust, and a process built around making people feel at ease before the camera ever comes out. That's the work at Bread Loaf, and it's the kind of challenge we find most meaningful: not capturing what the conference looks like, but what it feels like to be there.",
    ...
    pageTitle: "Vermont Brand Film — Middlebury College | Corey Hendrickson",
  ...
  },
  {
    ...
    pageTitle: "New England Travel Documentary — Yankee Publishing | Corey Hendrickson",
  ...
  },
  {
    ...
    pageTitle: "Vermont Hospitality Brand Film — Woodstock Inn & Resort | Corey Hendrickson",
  ...
  },
  {
    ...
    keywords: "Yankee Magazine, New England, PBS, Weekends With Yankee, Weekends with Yankee season 10, season 10, Insider's Guide, Travel, Tourism, Adventure, Documentary New England, DP, Director, Explore, Taste, Culinary, Amy Traverso, Richard Wiese, New England travel series, PBS travel show",
    ...
    pageTitle: "Weekends With Yankee | PBS Series — Corey Hendrickson",
    gallery: pbsGallery,
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
  {
    title: "Hotel Vermont",
    slug: "hotel-vermont",
    image: "/images/hotel-vermont/Hotel_Vermont-1.jpg",
    description: [
      "Most hotels treat art as decoration. Hotel Vermont treats it as an introduction.",
      "The hotel's walls are filled with work by Vermont artists, chosen not just for aesthetics but for what they say about this place and the people who make things here. We traveled across Vermont filming those artists in their studios: wood sculptors, printmakers, glassblowers whose handmade pieces carry the fingerprints of their makers. We let them tell the stories behind the work guests were already living with in their rooms. The films played on a dedicated in-room channel, giving anyone who wanted it the chance to look at the wood sculpture in the corner or the print on the wall with completely different eyes.",
    ...
    pageTitle: "Vermont Hotel Brand Film — Hotel Vermont, Burlington | Corey Hendrickson",
    gallery: [
      "/images/hotel-vermont/Hotel_Vermont-1.jpg",
      "/images/hotel-vermont/Hotel_Vermont-2.jpg",
      "/images/hotel-vermont/Hotel_Vermont-3.jpg",
      "/images/hotel-vermont/Hotel_Vermont-4.jpg",
      "/images/hotel-vermont/Hotel_Vermont-6.jpg",
      "/images/hotel-vermont/Hotel_Vermont-5.jpg",
      "/images/hotel-vermont/Hotel_Vermont-7.jpg",
      "/images/hotel-vermont/Hotel_Vermont-8.jpg",
      "/images/hotel-vermont/Hotel_Vermont-9.jpg",
      "/images/hotel-vermont/Hotel_Vermont-10.jpg",
      "/images/hotel-vermont/Hotel_Vermont-11.jpg",
      "/images/hotel-vermont/Hotel_Vermont-12.jpg",
      "/images/hotel-vermont/Hotel_Vermont-13.jpg",
      "/images/hotel-vermont/Hotel_Vermont-15.jpg",
      "/images/hotel-vermont/Hotel_Vermont-14.jpg",
      "/images/hotel-vermont/Hotel_Vermont-16.jpg",
      "/images/hotel-vermont/Hotel_Vermont-17.jpg",
      "/images/hotel-vermont/Hotel_Vermont-21.jpg",
    ],
  },
  {
    title: "Boeing",
  ...
  },
  {
    ...
    pageTitle: "Run Back the Miracle — NBC Peacock Documentary | Corey Hendrickson",
    gallery: nbcGallery,
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
  {
    ...
    pageTitle: "Nonprofit Documentary Film — Camphill Foundation | Corey Hendrickson",
  ...
  },
  {
    ...
    pageTitle: "Vermont Sports Brand Film — Untapped | Corey Hendrickson",
  ...
  },
  {
    ...
    pageTitle: "Vermont Documentary Film — Ramen Day | Corey Hendrickson",
