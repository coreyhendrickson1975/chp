...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: [
      "The Woodstock Inn & Resort has spent decades earning something most brands can't buy: the feeling that luxury and Vermont authenticity aren't in tension. They're the same thing. Our job was to make sure the film and photography felt the same way.",
      "That meant moving across wildly different environments (ski hill, spa, fine dining, open trails) without letting the content feel like a catalog. The real challenge wasn't visual consistency. It was emotional consistency. Every frame needed to carry the same quiet confidence the Inn itself carries.",
      "We worked with professional models and local talent alike, and in both cases the approach was the same: slow down, create an atmosphere where people stop performing and start being. Authenticity at this level isn't accidental. It's earned on set, one moment at a time.",
      "The result isn't a content library that shows what the Woodstock Inn offers. It's one that shows why people fall in love with it.",
    ],
