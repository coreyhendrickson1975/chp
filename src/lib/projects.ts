...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: [
      "The Miracle on Ice has been told a thousand times... What Michelob Ultra set out to do was make you feel it for the first time again.",
      "Run Back the Miracle was a half-hour Peacock special built around a large-scale projection installation that brought historic 1980 game footage back to the Herb Brooks Arena, the very ice where it happened, with Al Michaels returning to bear witness. Key members of the 1980 team were also there in person, including captain Mike Eruzione, goalie Jim Craig, and forward Mark Johnson. It was a genuinely new way to experience a story everyone thought they already knew.",
      ...
      "When a story is this familiar, the challenge isn't telling it. It's finding the angle that makes it land like new. That's exactly what this project was built around, and exactly the kind of work we are drawn to.",
    ],
